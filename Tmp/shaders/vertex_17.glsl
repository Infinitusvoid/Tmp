...
void main()
{
    ...
    float color_b = value_wave_0.b * f_1 + value_wave_1.b * f_0;
    */
    vec4 wave = wave(rnd_x * 10.001, rnd_y * 0.0001, uTime);

    float radius = 0.1 + wave.w * 1.0;
    ...
    float scale_cube = 0.0002 * 0.2;
    vec3  pos = vec3(px, pz - 0.01 + 0.01 * sin(px * 100.0) + 0.01 * cos(py * 100.0), py);
